...
class NestVNet(nn.Module):
    def __init__(self, in_channels, num_class, **kwargs):
        ...
        self.up1_1 = UpBlock(feats[1], feats[0], feats[0], norm_type=norm_type, act_type=act_type, se_type=se_type,
                             drop_type=drop_type, num_blocks=1, use_bottle_neck=use_bottle_neck)
...
class NestVBNet(NestVNet):
    def __init__(self, in_channels, num_class, **kwargs):
        super(NestVBNet, self).__init__(in_channels, num_class, use_bottle_neck=True, **kwargs)


class NestVBNet_CSE(NestVBNet):
    def __init__(self, in_channels, num_class, **kwargs):
        super(NestVBNet_CSE, self).__init__(in_channels, num_class, se_type='cse', **kwargs)


class NestVBNet_SSE(NestVBNet):
    def __init__(self, in_channels, num_class, **kwargs):
        super(NestVBNet_SSE, self).__init__(in_channels, num_class, se_type='sse', **kwargs)


class NestVBNet_SCSE(NestVBNet):
    def __init__(self, in_channels, num_class, **kwargs):
        super(NestVBNet_SCSE, self).__init__(in_channels, num_class, se_type='scse', **kwargs)
